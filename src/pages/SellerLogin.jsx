...
const SellerLogin = () => {
  ...
  const sellerState = useSelector((state) => state);

  const { seller, isError, isSuccess, isLoading, message } = sellerState.seller;

  useEffect(() => {
    const token = localStorage.getItem("token");
    if (seller || isSuccess || token) {
  ...
  }, [seller, isError, isSuccess, isLoading, navigate]);
  ...
  return (
    <>
      <div className=" bg-[#fff8f8]  flex flex-col  justify-center pt-6 ">
            ...
            <form className="space-y-6" onSubmit={formik.handleSubmit}>
              ...
              <div>
                <h4 className="text-center">
                  ...
                  <Link to="/seller-register" className="text-blue-600 pl-2 underline">
                    REGISTER
                  </Link>
                </h4>
              </div>
